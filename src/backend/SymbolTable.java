...
public class SymbolTable {
    ...
    public static Symbol lookupLocalTable(String name, Symbol.TYPE type) {
        Iterator<Symbol> it = headerScope.symbolTable.iterator();
        while (it.hasNext()) {
            Symbol sb = it.next();
...
//            }
    ...
    public static Symbol lookupGlobalTable(String name, Symbol.TYPE type) {
...
//                }
    ...
    public static Symbol lookupFullTable(String name, Symbol.TYPE type) {
    ...
    public static Symbol lookupLocalTable(String name, Symbol.TYPE type, Scope scope) {
//        Iterator<Symbol> it = scope.symbolTable.iterator();
//        while (it.hasNext()) {
//            Symbol sb = it.next();
//            if (sb.getName().equals(name) && sb.getType() == type) {
...
//        }
    ...
    public static Symbol lookupGlobalTable(String name, Symbol.TYPE type, Scope scope) {
//        Scope sc = scope;
//        while (sc.father != null) {
//            sc = sc.father;
//            Iterator<Symbol> it = sc.symbolTable.iterator();
...
//        }
    ...
    public static Symbol lookupFullTable(String name, Symbol.TYPE type, Scope scope) {
